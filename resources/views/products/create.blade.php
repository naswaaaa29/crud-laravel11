            ...
            <form enctype="multipart/form-data" action="{{route('products.store')}}" method="post">
              ...
              <div class="card-body">
                <div class="mb-4">
                  ...
                  <input value="{{old('id')}}" type="text" class="@error('id') is-invalid @enderror form-control-lg form-control"
                ...
                <div class="mb-4">
                  ...
                  <input value="{{old('name')}}" type="text" class="@error('name') is-invalid @enderror form-control-lg form-control"
