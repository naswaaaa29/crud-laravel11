        ...
        <div class="col-md-8">
          <div class="card borde-0 shadow-lg my-4">
            ...
            <form enctype="multipart/form-data" action="{{route('products.update', $product->id)}}" method="post">
              ...
              <div class="card-body">
                <div class="mb-4">
                  <label for="" class="form-label h6">Id</label>
                  <input value="{{old('id', $product->id)}}" type="text" class="@error('id') is-invalid @enderror form-control-lg form-control"
                ...
                <div class="mb-4">
                  ...
                  <input value="{{old('name', $product->name)}}" type="text" class="@error('name') is-invalid @enderror form-control-lg form-control"
                ...
                <div class="mb-4">
                  ...
                  name="image">
                    ...
                    @if ($product->image != "")
                        <img class="w-50 my-4" src="{{asset('uploads/products/'.$product->image)}}" alt="">
                    @endif
                </div>
                <div class="d-grid">
